...
from cases.spec_to_pr.prompts import CODEWRITER_PROMPT, PLANNER_PROMPT, REVIEWER_PROMPT
from cases.spec_to_pr.tools import generate_diff, validate_diff

load_dotenv()
logger = get_logger("spec_to_pr")
...
---
*Generated by spec_to_pr agent — framework_multiagentes*
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="spec_to_pr — generate a PR draft from a spec")
